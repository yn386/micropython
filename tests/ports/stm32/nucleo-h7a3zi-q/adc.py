# For weact-h723vg, ADC(16) and ADC(17) does not connect to
# internal sensors. 
# In this test case, check whether value is between 0 and
# original test case.
